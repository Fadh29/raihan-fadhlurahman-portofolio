      ...
      <nav className="navbar">
        <div className="container nav-container">
          ...
          <ul className={`nav-links ${isOpen ? 'open' : ''}`}>
            ...
            <li className="mobile-only-action">
              <a href="/CV_ATS_Raihan_Fadhlurahman.pdf" download="CV_ATS_Raihan_Fadhlurahman.pdf" className="btn btn-primary nav-action-btn">DOWNLOAD CV</a>
            </li>
          </ul>

          <div className="nav-actions-desktop">
            <a href="mailto:fadhlurahmanraihan29@gmail.com" className="btn btn-secondary nav-btn-secondary">EMAIL ME</a>
            <a href="/CV_ATS_Raihan_Fadhlurahman.pdf" download="CV_ATS_Raihan_Fadhlurahman.pdf" className="btn btn-primary nav-btn-primary">DOWNLOAD CV</a>
          </div>
